...
vezesstory = random.randint(5, 15)    # define quantidade de loops para curtir os storyes   #linha 73
...
for i in range(doloop):   # ref linnha 33
    ...
    def likecoment():
        ...
        for isso in range(luvas):
            def inscrevase():
                time.sleep(tempo5)
                botseguir = pyautogui.locateOnScreen('seguir.png')
                pyautogui.click(botseguir)
                time.sleep(1)
                botseguir2 = pyautogui.locateOnScreen('seguir2.png')
                pyautogui.click(botseguir2)
                time.sleep(1)
                botseguir3 = pyautogui.locateOnScreen('seguir3.png')
                pyautogui.click(botseguir3)
                time.sleep(tempo5)
                botaolike = pyautogui.locateOnScreen('like.png')
                ...
                comentar = ["Que Show!!", "Gostei! Muito Massa!", "Like!!", "uhu da hora a foto.",
                            ...
                            "show! Essa foto merece varios likes.", "legal!",
                            "Que massa! essa foto merece varios likes. rsrsrsrsr", "Caramba! Ta bem em?!",
                            "Like! Like! Like!", "muito massa", "extraordinario!", "Shoowww!", "Isso aí! parabens",
                            "top tua postagem. isso ai!", "Muito, muito bom!", "chaaama!",
